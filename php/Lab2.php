...
echo "<html>";
echo "<head><title>การสร้างฟอร์มในการรับค่าเพื่อค านวณ</title></head>";
echo "<body>";
echo "<form method='get' action='Lab.php'>";
echo "<table border='1' align='center' width='500'>";
    ...
    echo "<tr>";
        ...
        echo "<td><input type='number' name='number1'  size='15' value=''/> </td>";
    echo "<tr>";
    echo "<tr>";
        echo "<td> Operator : </td>";
